          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="{{route('meeting-details')}}"><img src={{ asset("assets/images/single-meeting.jpg")}} alt=""></a>
                </div>
                <div class="down-content">
                  <a href="{{route('meeting-details')}}"><h4>Online Teaching and Learning Tools</h4></a>
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="{{route('meetings')}}">Back To Meetings List</a>
              </div>
            </div>
          </div>
        </div>
