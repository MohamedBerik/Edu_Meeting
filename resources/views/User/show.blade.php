                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $result->status == 'active' ? 'success' : 'secondary' }}">
                                            {{ $result->status }}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('user.edit', $result->id) }}" class="btn btn-sm btn-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('user.delete', $result->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
